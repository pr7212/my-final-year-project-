...
<div class="container">
  ...
  <form id="user-form" method="POST" style="margin:20px 0; padding:20px; background:#f9f9f9; border-radius:8px;">
    ...
    <div style="display:flex; gap:10px; margin-bottom:10px;">
      ...
      <input type="password" name="password" placeholder="Password" minlength="8" required style="flex:1; padding:10px;">
    </div>
        ...
        data.data.forEach(row => {
          tbody.innerHTML += `
            <tr>
              ...
              <td><span style="background:#e3f2fd; padding:4px 8px; border-radius:12px; font-size:0.9em;">${escapeHtml(row.role)}</span></td>
